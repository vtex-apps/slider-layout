...
export const mockInitialInfiniteSliderState = {
  ...
  slides: [
    <div key={-1}>I am a slide</div>,
    <div key={-2}>I am a slide</div>,
    <div key={-3}>I am a slide</div>,
    <div key={-4}>I am a slide</div>,
    <div key={-5}>I am a slide</div>,
    ...
    <div key={11}>I am a slide</div>,
    <div key={12}>I am a slide</div>,
    <div key={13}>I am a slide</div>,
    <div key={14}>I am a slide</div>,
    <div key={15}>I am a slide</div>,
  ],
  navigationStep: 5,
  slideTransition: {
    speed: 400,
