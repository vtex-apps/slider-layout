...
With everything set up, Google Analytics is now able to track your internal promotions and generate a full report of its views, clicks, click-through rate, conversions, and revenue. 
